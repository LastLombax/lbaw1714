...
<table>
 ...
 ```sql
    CREATE INDEX event_id_idx ON "event" USING btree (idevent);
  ```
...
BEGIN
  DELETE FROM "friend"
  WHERE (old.idf1 = friend.idf2 AND old.idf2 = friend.idf1);
  RETURN NEW;
END
$BODY$
LANGUAGE plpgsql;
...
<table>
 <tr>
  ...
  <td>TRIGGER04</td>
   ...
   <tr>
   <td><strong>Trigger Description</strong></td>
   <td>Before buying a ticket, an invoice row is created</td>
   </tr>
</table>
