...
UPDATE Friend
SET accepted = true
WHERE ("idFriend1" = $_SESSION['currentCommunity'] AND "idFriend2 = $acceptedFriend) OR
      ("idFriend2" = $_SESSION['currentCommunity'] AND "idFriend1 = $acceptedFriend);
```
...
$BODY$
BEGIN
  IF SELECT TicketType.avaiableQuantity - NEW. >= 0
