...
<table>
 <tr>
  ...
  <td>UPDATE05</td>
   ...
   <tr>
   <td><strong>Query Description</strong></td>
   <td>Make Member Website Admin</td>
   </tr>
  <tr>
  <td><strong>Query Frequency</strong></td>
  <td>hundreds per day</td>
...
INSERT INTO "event" VALUES
 ($id, $name, $description, $imagePath, $startDay, $endDay', $startTime, $endTime, $country, $city, $address, $publicLink, $isPublic, $community);
```
...
```
 ...
 Eventos:
 criar comentários
 convidar membros (criar notificação)
 ...
 convidar membros (criar notificação)
 remover membros (flag)
 Criar Evento de Comunidade (todos os membros são convidados)
...
Report:
 inserid report de evento, comunidade ou outro membro 
 
 
Qualquer notificação gerada
