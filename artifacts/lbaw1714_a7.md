...
* **R108: Edit Profile Action** `/users/{id}/edit`
...
* R202: Search Event API `/api/events`  **hmmmm?**
* R203: View Event `/events/{id}`
* R204: Add Event Form `/events/create`
* R205: Add Event Action `/events/create`
* R206: Edit Event Form `/events/{id}/edit`
* R207: Edit Event Action `/events/{id}/edit`
* R208: Invite Person Form `/events/{id}/invite` **hmmmmm?**
* R209: Invite Person Action `/events/{id}/invite`
* R210: Delete Event Action `/events/{id}`
* R211: Delete Item Action `/events/{id}/`
