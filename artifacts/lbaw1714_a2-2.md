...
![19113349_1540989372600007_577113561_n](https://raw.githubusercontent.com/LastLombax/lbaw1714/master/Deliverables/actors.png?token=AYlAMX8nq1IUK9XmSBH6jNzU6UpDoTtGks5a1FmXwA%3D%3D)
...
| M01 | Edit Event | High | As an Event Administrator, I want to edit an Event in which I have permissions, so I can change any of its traits. |
| --- | --- | --- | --- |
| M02 | Delete Event | High | As an Event Administrator, I want to delete an Event, to erase it from the platform. |
| M03 | Flag a comment | Medium | As an Event Administrator, I want to flag a comment as inappropriate. |
| M04 | Kick a Member | Medium | As an Event Administrator, I want to be able to kick someone from an Event I am administrating, in case of inappropriate conduct. |

### 2.5. Community Administrator

| M01 | Invite a Member to a Community | High | As a Community Administrator, I want to be able to invite a Member to a Community, so he / she can join the Community. |
| --- | --- | --- | --- |
| M02 | Kick Member | High | As a Community Administrator, I want to delete a Member from the  Community, to remove him/her from the Community. |
| M03 | Delete Community | Medium | As a Member, I want to be able to delete a community to remove it from the platform. |
