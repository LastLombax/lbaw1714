...
| R13                | Notification(__idNotification__, community->Community, recipient->Member **NN**, event-Event, comment->Comment) |
| R14                | Report(__idReport__, timestamp, context **NN**, community->Community, reporter->Member **NN**, event-Event, comment->Comment) |
