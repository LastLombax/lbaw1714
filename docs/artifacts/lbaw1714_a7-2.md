...
<th>Parameters</th>
<td>+username: integer</td>
<td>username: Member's username</td>
</tr>
<tr>
...
<tr>
<th>URL</th>
<td colspan="2">/member/tickets</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/member/tickets/{id}</td>
</tr>
<tr>
<th>Description</th>
...
* R501: Search Community Page `/communities`
* R502: View Community `/communities/{id}`
* R503: Create Community Form `/communities/create`
* R504: Create Community Action `/communities/create`
* R505: Edit Community Form `/communities/{id}/edit`
* R506: Edit Community Action `/communities/{id}/edit`
* R507: Invite Person Form `/communities/{id}`
* R508: Invite Person Action `/communities/{id}/invite`
* R509: Delete Community Action `/communities/{id}`
* R510: Community Search API `/api/communities`

#### R501: Search Community Page
...
* R601: View Reports `/administration/reports`
* R602: Process Report Action `/administration/reports/{id}`
* R603: Ban Event `/administration/ban_event`
* R604: Ban Event Action`/administration/ban_event/{id}`
* R605: Ban Community `/administration/ban_community`
* R606: Ban Community Action `/administration/ban_community/{id}`
* R607: Ban Member `/administration/ban_member`
* R608: Ban Member Action `/administration/ban_member/{id}`
* R609: Remove Comment `/administration/remove_comment`
* R610: Remove Comment Action `/administration/remove_comment/{id}`
* R611: Add Admin Privileges `/administration/admin`
* R612: Add Admin Privileges Action `/administration/admin/{id}`

####  R601: View Reports
<table>
<tr>
<th>URL</th>
<td colspan="2">/administration/reports</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/reports/{id}</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_event</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_community</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_member</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/remove_comment</td>
</tr>
<tr>
<th>Description</th>
...
####  R612: Add Admin Privileges Action
<table>
<tr>
<th>URL</th>
