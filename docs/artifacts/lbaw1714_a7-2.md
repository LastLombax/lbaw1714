...
* R201: Search Member `/members/{pageNum}`
...
<tr>
<th>URL</th>
<td colspan="2">/members/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
* R301: Search Event Page `/events/{pageNum}`
...
* R403: Manage Purchased Tickets `/members/tickets/{pageNum}`
...
<tr>
<th>URL</th>
<td colspan="2">/member/tickets/{idticket}</td>
</tr>
<tr>
<th>Description</th>
...
* R501: Search Community Page `/communities/{pageNum}`
...
<tr>
<th>URL</th>
<td colspan="2">/communities/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
* R601: View Reports `/administration/reports/{pageNum}`
* R602: Process Report Action `/administration/reports/{idreport}`
* R603: Ban Event `/administration/ban_event/{pageNum}`
* R604: Ban Event Action`/administration/ban_event/{idevent}`
* R605: Ban Community `/administration/ban_community/{pageNum}`
* R606: Ban Community Action `/administration/ban_community/{idcommunity}`
* R607: Ban Member `/administration/ban_member/{pageNum}`
* R608: Ban Member Action `/administration/ban_member/{idmember}`
* R609: Remove Comment `/administration/remove_comment/{pageNum}`
...
<tr>
<th>URL</th>
<td colspan="2">/administration/reports/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_event/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_community/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/ban_member/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
...
<tr>
<th>URL</th>
<td colspan="2">/administration/remove_comment/{pageNum}</td>
</tr>
<tr>
<th>Description</th>
