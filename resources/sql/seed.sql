...
insert into event (name, description, imagepath, startDay, endDay, startTime, endTime, country, city, address, publiclink, ispublic, community) values ('Focused intermediate migration', 'Traumatic hemorrhage of cerebrum, unspecified, with loss of consciousness greater than 24 hours without return to pre-existing conscious level with patient surviving, sequela', 13, '2018-06-20 19:55:13', '2/3/2018', '6:34 AM', '7:01 PM', 'Belgium', 'Momignies', '81119 Dakota Pass', '/augue/quam/sollicitudin/vitae.jpg', false, null);
